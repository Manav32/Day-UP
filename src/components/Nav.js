...
export default function(){
    return <div className="w-full p-4 pr-20 text-lg text-white flex justify-evenly px-12 lg:px-0">
        <div className="LoginBtn p-3 pb-4 text-center px-4 rounded-3xl text-blue-200 bg-slate-900 mx-12 flex flex-row list-none items-center justify-between w-72">
            <li className="gear mr-5 lg:mr-0">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-3 bi bi-search hover:cursor-pointer" viewBox="0 0 16 16">
